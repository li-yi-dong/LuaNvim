...
telescope.setup {
  defaults = {
    ...
    mappings = {
      i = {
        ["<S-n>"] = actions.cycle_history_next,
        ["<S-p>"] = actions.cycle_history_prev,
        ...
        ["<S-u>"] = actions.preview_scrolling_up,
        ...
        ["<S-l>"] = actions.complete_tag,
        ["<S-_>"] = actions.which_key, -- keys from pressing <C-/>
      },
